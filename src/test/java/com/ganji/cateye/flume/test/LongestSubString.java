...
//		System.out.println(maxRepeat);
	...
	public static void findMaxPrefix(String str){  
    ...
    public static String[] generateSuffixArray(String str){  
        int len=str.length();  
